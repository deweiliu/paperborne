...
public final class GraphicsHelper {
     ...
     */
    public static final boolean isVisible(BoundingBox bound, LayerViewport layerViewport) {
     ...
     * @return True if the specified bound is visible, False otherwise
     */
    public static final boolean getSourceAndScreenRect(BoundingBox bound, Bitmap bitmap,
                                                       LayerViewport layerViewport, ScreenViewport screenViewport,
                                                       Rect sourceRect, Rect screenRect) {
     ...
     * @return True if the specified object is visible, False otherwise
     */
    public static final boolean getClippedSourceAndScreenRect(BoundingBox bound, Bitmap bitmap,
                                                              LayerViewport layerViewport, ScreenViewport screenViewport,
                                                              Rect sourceRect, Rect screenRect) {

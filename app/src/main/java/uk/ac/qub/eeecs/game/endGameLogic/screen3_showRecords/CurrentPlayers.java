...
public class CurrentPlayers extends AllGameRecords {
    private Paint mPaint;

    public CurrentPlayers(EndGameScreen mEndGameScreen) {
    ...
    public void draw(ElapsedTime elapsedTime, IGraphics2D graphics2D) {
        ...
        graphics2D.drawText("Hello, showing current player records", 0, mEndGameScreen.getScreenHeight() / 4, mPaint);

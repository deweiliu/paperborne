...
public class MovingObject extends GameObject {
    ...
    public MovingObject(float x, float y, float width, float height, Bitmap bitmap, GameScreen gameScreen) {
        super(x, y, width, height, bitmap, gameScreen);
        initialize(x, y);
    }

    public MovingObject(float x, float y, Bitmap bitmap, GameScreen gameScreen) {

 ...
 * Created by Jamie Thompson & Dewei Liu in Dec 2017
 * @version 1.0
 */
...
public class OptionsScreen extends GameScreen {
    ...
    public OptionsScreen(Game game) {
        ...
        mLayerViewport = new LayerViewport(SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2, SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2);
        mScreenViewport = new ScreenViewport(0, 0, (int) SCREEN_WIDTH, (int) SCREEN_HEIGHT);
        ...
        mOptionsScreenBackground = new GameObject(SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2, SCREEN_WIDTH, SCREEN_HEIGHT,
                getGame().getAssetManager().getBitmap("OptionsScreenBackgroud1"), this);


        // Define the spacing that will be used to position the buttons
        int buttonWidth = (int) (SCREEN_WIDTH / 5);
        int buttonHeigth = (int) (SCREEN_WIDTH / 3);

        // Create the push button
        stopShifting = new PushButton(
                buttonWidth * 4.0f, buttonHeigth * 0.5f, buttonWidth, buttonHeigth, "StopShifting", this);
        startShifting = new PushButton(
                buttonWidth * 1.0f, buttonHeigth * 0.5f, buttonWidth, buttonHeigth, "StartShifting", this);
        // Create back button
        back = new PushButton(BACK_WIDTH / 2, BACK_HEIGHT / 2, BACK_WIDTH, BACK_HEIGHT, "Back", this);
        // Create toggle option change button
        testOption = new ToggleButton(200.0f, SCREEN_HEIGHT / 2, 180.0f, 160.0f, "ToggleOn", "ToggleOff", this);
    ...
    public void draw(ElapsedTime elapsedTime, IGraphics2D graphics2D) {
        ...
        graphics2D.drawText(String.format(OPTION_TEXT, currentOption), 300.0f, SCREEN_HEIGHT / 2, optionText);
